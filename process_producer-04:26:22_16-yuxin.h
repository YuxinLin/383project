...
#define NUM_PROCESS 60 //26 max possible number
...
struct process{
    ...
    float actual_start_time; // when the process is contacted by CPU for first time
    float end_time; // process finishes
